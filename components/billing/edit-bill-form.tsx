    ...
    try {
      const payload = {
        items: billItems.filter(
          (i) =>
            i.itemName.trim() !== "" && i.unitPrice !== null && i.unitPrice > 0,
        ),
        discountAmount,
        paymentMethod,
        notes,
      ...
      <div className="bg-white rounded-lg max-w-4xl w-full max-h-[90vh] overflow-y-auto">
        <div className="flex justify-between items-center p-6 border-b">
          <h2 className="text-2xl font-bold">
            Edit Bill #{bill.billNumber || bill.id}
          </h2>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Edit bill items, rates, and taxes
              </CardDescription>
            </CardHeader>
            <CardContent>
                      ...
                      <tr key={idx} className="hover:bg-gray-50">
                        <td className="px-3 py-2 border">
                          <select
                            value={item.itemType}
                            onChange={(e) =>
                              updateBillItem(idx, "itemType", e.target.value)
                            }
                        ...
                        <td className="px-3 py-2 border">
                          <Input
                            value={item.itemName}
                            onChange={(e) =>
                              updateBillItem(idx, "itemName", e.target.value)
                            }
                          />
                        </td>
