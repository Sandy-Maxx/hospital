...
export default function ProfileWizard() {
  ...
  const StepProfessional = isAdmin ? (
                ...
                <select
                  ...
                  onChange={(e) =>
                    setProfile((p) => ({
                      ...
                      designation: {
                        ...(p.designation || {}),
                        changelog: (p.designation?.changelog || []).map(
                          (r, i) =>
                            i === idx
                    ...
                    setProfile((p) => ({
                      ...
                      designation: {
                        ...
                        changelog: (p.designation?.changelog || []).map(
                          (r, i) =>
                            i === idx
                              ? { ...r, fromYear: Number(e.target.value) }
                              : r,
                        ),
                      },
                    }))
                ...
                <Button
                  ...
                  onClick={() =>
                    setProfile((p) => ({
                      ...
                      designation: {
                        ...(p.designation || {}),
                        changelog: (p.designation?.changelog || []).filter(
                          (_, i) => i !== idx,
                        ),
                      },
                    }))
            ...
            onClick={() =>
              setProfile((p) => ({
                ...
                designation: {
                  ...(p.designation || {}),
                  changelog: [
                    ...(p.designation?.changelog || []),
                    {
                      designation: p.designation?.current || "",
    ...
    <div className="text-sm text-gray-500">
      Only administrators can edit professional details.
    </div>
  );
  ...
  const StepQualifications = isAdmin ? (
          ...
          <div className="col-span-3">
            <select
              ...
              onChange={(e) =>
                setProfile((p) => ({
                  ...p,
                  qualifications: (p.qualifications || []).map((r, i) =>
            ...
            <select
              ...
              onChange={(e) =>
                setProfile((p) => ({
                  ...p,
                  qualifications: (p.qualifications || []).map((r, i) =>
                    i === idx ? { ...r, stream: e.target.value } : r,
                  ),
                }))
              }
            >
            ...
            <Input
              ...
              onChange={(e) =>
                setProfile((p) => ({
                  ...p,
                  qualifications: (p.qualifications || []).map((r, i) =>
                    i === idx ? { ...r, year: Number(e.target.value) } : r,
                  ),
                }))
              }
            />
      ...
      <Button
        ...
        onClick={() =>
          setProfile((p) => ({
            ...
            qualifications: [
              ...(p.qualifications || []),
              { degree: DEGREE_OPTIONS[0], stream: STREAM_OPTIONS[0] },
            ],
          }))
        }
      >
    ...
    <div className="text-sm text-gray-500">
      Only administrators can edit qualifications.
    </div>
  );
  ...
  const StepExperience = isAdmin ? (
          ...
          <div className="col-span-3">
            <Input
              ...
              onChange={(e) =>
                setProfile((p) => ({
                  ...p,
                  experience: (p.experience || []).map((r, i) =>
                    i === idx ? { ...r, organization: e.target.value } : r,
                  ),
                }))
              }
            />
            ...
            <Input
              ...
              onChange={(e) =>
                setProfile((p) => ({
                  ...p,
                  experience: (p.experience || []).map((r, i) =>
                    i === idx ? { ...r, fromYear: Number(e.target.value) } : r,
                  ),
                }))
              }
            />
    ...
    <div className="text-sm text-gray-500">
      Only administrators can edit experience.
    </div>
  );
  ...
  const StepReview = (
    <div className="space-y-2 text-sm">
      ...
      <div>
        <strong>Designation:</strong> {profile.designation?.current || "-"}
      </div>
      <div>
      ...
      <div>
        <strong>Experience:</strong> {(profile.experience || []).length} item(s)
      </div>
    </div>
  );
    ...
    <div className="space-y-6">
      ...
      <Card>
        ...
        <CardContent>
          ...
          <div className="space-y-4">{render()}</div>
