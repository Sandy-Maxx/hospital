...
async function main() {
  ...
  const medicines = [
    ...
    { name: 'Amoxicillin', genericName: 'Amoxicillin', category: 'Antibiotic', dosageForm: 'Capsule', strength: '250mg' },
    { name: 'Ibuprofen', genericName: 'Ibuprofen', category: 'NSAID', dosageForm: 'Tablet', strength: '400mg' },
    { name: 'Cough Syrup', genericName: 'Dextromethorphan', category: 'Antitussive', dosageForm: 'Syrup', strength: '100ml' },
    { name: 'Aspirin', genericName: 'Acetylsalicylic acid', category: 'Analgesic', dosageForm: 'Tablet', strength: '75mg' },
  ]
  ...
  const appointmentStatuses = ['SCHEDULED', 'COMPLETED', 'CANCELLED', 'IN_PROGRESS']
