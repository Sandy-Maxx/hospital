...
export function formatBillNumber(bill: { billNumber?: string | null; id: string; createdAt?: string | Date }): string {
...
export function formatPrescriptionNumber(presc: { id: string; createdAt?: string | Date }): string {
